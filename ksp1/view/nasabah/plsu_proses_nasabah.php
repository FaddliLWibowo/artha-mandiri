...
elseif($view=='nasabah' AND $act=='input'){
	...
	$nasabah					="INSERT INTO nasabah
										(no_rekening,cabang,wajib,nama,jenis_kelamin,tanggal_lahir,pekerjaan,alamat,hp,tgldibuat,petugas) 
            					  VALUES('$no_rekening','$cabang','$wajib','$nama','$jenis_kelamin','$tanggal_lahir','$pekerjaan','$alamat_nasabah','$hp_nasabah',now(),'$petugas')";
