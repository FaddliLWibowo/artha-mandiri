...
elseif($view=='nasabah' AND $act=='input'){
	...
	$nasabah					="INSERT INTO nasabah
										(no_rekening,cabang,nama,jenis_kelamin,tanggal_lahir,pekerjaan,alamat,no_identitas,hp,tgldibuat,petugas) 
            					  VALUES('$no_rekening','$cabang','$nama','$jenis_kelamin','$tanggal_lahir','$pekerjaan','$alamat_nasabah','$no_identitas','$hp_nasabah',now(),'$petugas')";
	$sukarela					="INSERT INTO simpanan(no_simpanan,no_rek,tanggal,jenis,kode,nominal,petugas) 
								  VALUES('$no_sukarela','$no_rekening',now(),'S','D','$nominal','$petugas')";
	$pokok						="INSERT INTO simpanan (no_simpanan,no_rek,tanggal,jenis,kode,nominal,petugas) 
